...
module.exports = {
  theme: {
    extend: {
      colors: {
        'primary-5-color': '#0277bd',
        'primary-4-color': '#58a5f0',
        'primary-6-color': '#004c8c',
        ...
        'on-primary-5-color': '#ffffff',
        'on-primary-4-color': '#000000',
        'on-primary-6-color': '#ffffff',
        ...
        // 'on-secondary-5-color': 'var(--on-secondary-color)',
